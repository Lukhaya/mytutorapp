...
const tutorials = [
    { id: 1, title: "Computer Science", dateTime: "CSC3003S", venue: "Amahle Jenete, Inathi Bulwana, Reabetsoe Mpapa" },
    { id: 2, title: "Embedded Systems", dateTime: "EEE3096S", venue: "Amahle Jenete, Inathi Bulwana, Reabetsoe Mpapa" }
...
function displayModal(mode){
    ...
    if(mode==="edit"){
        ...
        document.getElementById("dateTime").value= tutObj.dateTime;
